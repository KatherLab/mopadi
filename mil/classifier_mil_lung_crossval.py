...
feat_path = f"{ws_path}/extracted_features/TCGA-LUAD-LUSC/lung-train"
feat_path_val = f"{ws_path}/extracted_features/TCGA-LUAD-LUSC/lung-val"
out_dir = f"{ws_path}/mopadi/checkpoints/lung-subtypes-crossval"
annot_file = f"{ws_path}/mopadi/datasets/lung/clini_table.csv"
